...
firstday.coefs=coefficients(sr.wv.poly.firstday$model)

sr.wv.coefs<-rbind(maxDer.coefs,halfmax.coefs,maxVal.coefs,firstday.coefs)
colnames(sr.wv.coefs)=c('Int','Slope')
row.names(sr.wv.coefs)=c('maxDer','halfmax','maxval','firstday')
...
emo.coefs<-rbind(maxDer.coefs,halfmax.coefs,maxVal.coefs,firstday.coefs)
colnames(emo.coefs)=c('Int','Slope')
row.names(emo.coefs)=c('maxDer','halfmax','maxval','firstday')
